<x-jet-action-section>
    <x-slot name="title">
        Sessões Abertas em outros Navegadores
    </x-slot>

    <x-slot name="description">
        Gerencie e deslogue de sessões criadas neste e em outros dispositivos
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Caso necessário, você pode encerrar sua sessão de login aberta em outros computadores ou dispositivos
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                Deslogar de todas as sessões abertas
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                Digite sua Senha para confirmar a operação
